...
if (!message.member.permissions.has("MANAGE_GUILD")) return message.reply(`<a:795770153237217300:795770153237217300> Bu Komutu Kullanmak İçin **Yetkili** Olmalısın!`); 

let isim = args.slice(1).join(' ');
let kullanici = message.mentions.users.first();
  
if(!kullanici) return message.reply(`**Lütfen bir kullanıcı giriniz!** \n**Doğru Kullanım;** \`e!isimdeğiştir\` @${client.user.username}#${client.user.discriminator} \`<yeni isim>\``)
