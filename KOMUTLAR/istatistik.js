...
exports.run = async (client, message, args) => {
  ...
  const istatistikler = new Discord.MessageEmbed()
    .setColor("Elecus Bot İstatistik")
    ...
    .addField("**__Bot Sahibi__**", `<@794611591986675724> <@442488354886647809>`, true)
    .addField("**__Geliştirici__**", `<@794611591986675724> <@442488354886647809>`, true)
