...
exports.run = async function(client, message, args) {
 ...
 if (!message.member.permissions.has("MANAGE_MESSAGES")) return message.reply(`<a:795770153237217300:795770153237217300> Bu komutu kullanabilmek için **Mesajları Yönet** iznine sahip olmalısın!`);
 ...
 var fetched = await message.channel.messages.fetch({ limit: x })
  ...
  .catch(error => message.channel.send("`14` günden önceki mesajları silemem! <a:795770153237217300:795770153237217300>"))
